...
def train_CNN_model(model_name, training_images, testing_images, training_labels, testing_labels, unique_printings, epochs=10, verbose=True):
...
# Test the model with the test images and labels
test_loss, test_accuracy = model.evaluate(test_imgs, test_lbs)
