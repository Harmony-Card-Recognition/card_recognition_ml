...
def train_CNN_model(model_name, training_images, testing_images, training_labels, testing_labels, unique_printings, callbacks, verbose=True):
    ...
    model.fit(training_images, training_labels, callbacks=callbacks, validation_data=(testing_images, testing_labels))
...
model = train_CNN_model(model_name, train_imgs, test_imgs, train_lbs, test_lbs, unique_printings, callbacks=[accuracy_threshold_callback])
