...
def model_8(img_width, img_height, unique_classes):
    ...
    # First Convolutional Block
    model.add(layers.Conv2D(64, (3, 3), kernel_regularizer=regularizers.l2(0.01)))  # Added L2 regularization
    model.add(layers.LeakyReLU(negative_slope=0.01))
    model.add(layers.MaxPooling2D(2, 2))

    # Second Convolutional Block
    model.add(layers.Conv2D(128, (3, 3), kernel_regularizer=regularizers.l2(0.01)))  # Added L2 regularization
    model.add(layers.LeakyReLU(negative_slope=0.01))
    model.add(layers.MaxPooling2D(2, 2))

    # Third Convolutional Block
    model.add(layers.Conv2D(256, (3, 3), kernel_regularizer=regularizers.l2(0.01)))  # Added L2 regularization
    model.add(layers.LeakyReLU(negative_slope=0.01))
    model.add(layers.MaxPooling2D(2, 2))
    ...
    # Fifth Convolutional Block
    model.add(layers.Conv2D(512, (3, 3), kernel_regularizer=regularizers.l2(0.01)))  # Added L2 regularization
    model.add(layers.LeakyReLU(negative_slope=0.01))
    model.add(layers.MaxPooling2D(2, 2))

    # Flatten and Fully Connected Layers
    model.add(layers.Flatten())
    model.add(layers.Dense(2048, kernel_regularizer=regularizers.l2(0.01)))  # Added L2 regularization
    model.add(layers.LeakyReLU(negative_slope=0.01))
    model.add(layers.Dropout(0.6))  # Increased dropout rate from 0.5 to 0.6
    model.add(layers.Dense(unique_classes, activation='softmax'))
